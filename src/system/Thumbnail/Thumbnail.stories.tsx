...
AdaptiveResolution.parameters = {
	docs: {
		description: {
			story:
				'Demonstrates adaptive resolution support. The component automatically detects your device pixel ratio and requests appropriately sized images - 1x for standard displays, 2x+ for retina/high-DPI displays. This optimizes both image quality and bandwidth usage.',
		},
	},
};
