...
- Accept `ref` as a regular prop when wrapping HTML elements or Theme UI components (React 19 pattern). Add `ref?: React.Ref<T>` to the component's props type. Do not use `forwardRef` — it is no longer used in this codebase.
